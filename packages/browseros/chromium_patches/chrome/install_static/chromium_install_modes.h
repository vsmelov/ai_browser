...
+            L"{CF887152-7CB8-4393-84CC-1BACF0EDE1D1}",  // PonyClaw app GUID.
+        .base_app_name = L"PonyClaw",              // A distinct base_app_name.
+        .base_app_id = L"PonyClaw",                // A distinct base_app_id.
...
+            L"PonyClaw HTML Document",  // Browser ProgID description.
...
+            L"PonyClaw PDF Document",  // PDF ProgID description.
         .active_setup_guid =
