...
+            L"{CF887152-7CB8-4393-84CC-1BACF0EDE1D1}",  // PonyAI app GUID.
+        .base_app_name = L"PonyAI",              // A distinct base_app_name.
+        .base_app_id = L"PonyAI",                // A distinct base_app_id.
...
+            L"PonyAI HTML Document",  // Browser ProgID description.
...
+            L"PonyAI PDF Document",  // PDF ProgID description.
         .active_setup_guid =
