...
+// PonyClaw: feature flags
+inline constexpr char kBrowserOsAlphaFeaturesName[] =
+    "PonyClaw Alpha Features";
+inline constexpr char kBrowserOsAlphaFeaturesDescription[] =
+    "Enables PonyClaw alpha features.";
+
+inline constexpr char kBrowserOsClawdbotName[] = "PonyClaw Clawdbot";
...
+    "PonyClaw Keyboard Shortcuts";
+inline constexpr char kBrowserOsKeyboardShortcutsDescription[] =
+    "Enables PonyClaw keyboard shortcuts (Cmd+Shift+K, Cmd+Shift+L, "
