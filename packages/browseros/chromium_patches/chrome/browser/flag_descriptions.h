...
+// PonyAI: feature flags
+inline constexpr char kBrowserOsAlphaFeaturesName[] =
+    "PonyAI Alpha Features";
+inline constexpr char kBrowserOsAlphaFeaturesDescription[] =
+    "Enables PonyAI alpha features.";
+
+inline constexpr char kBrowserOsClawdbotName[] = "PonyAI Clawdbot";
...
+    "PonyAI Keyboard Shortcuts";
+inline constexpr char kBrowserOsKeyboardShortcutsDescription[] =
+    "Enables PonyAI keyboard shortcuts (Cmd+Shift+K, Cmd+Shift+L, "
